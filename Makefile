...
# AURORA_RELEASE_DIAG_MODE_TRACK_FINAL_V1_20260922
...
# The flag is also part of compile-mode.txt below so switching back to =0
# cannot reuse objects compiled with timing scopes still enabled.
