...
/* AURORA_SPC700_ACCURACY_BATCH2_V1_20260914: audited MOV/MOVW destination bus reads. */
	// NOP_
SNSPC_OP(0x000,2);
SNSPC_ENDOP(2)
...
SNSPC_ENDOP(2)
	...
	// SETP_
SNSPC_OP(0x040,2)
	/* AURORA_SPC700_SETP_FLAGS_V1: SETP changes P only. */
	SNSPC_SETFLAG_P();
SNSPC_ENDOP(2)
...
SNSPC_ENDOP(5)
	...
	// addr_dp_STYA_
SNSPC_OP(0x0da,4)
	/* AURORA_SPC700_MOVW_STORE_CYCLES_V1: MOVW dp,YA is 4 cycles. */
	SNSPC_FETCH8(t0);
	SNSPC_ADD(t0,r_DP);
	SNSPC_GET_YA16(t1);
	SNSPC_DUMMYREAD8(t0);
...
SNSPC_ENDOP(4)
	...
	// MUL_
SNSPC_OP(0x0cf,9)
	/* AURORA_SPC700_MUL_FLAGS_REFERENCE_V1
	 * MUL updates N/Z from Y, the high byte of the product, only. */
	SNSPC_GET_Y8(t0);
	SNSPC_GET_A8(t1);
	SNSPC_MUL(t1,t0);
	SNSPC_SET_YA16(t1);
